	...
	public function index() {
		...
		if (isset($this->request->post['config_open'])) {
			...
			$data['config_open'] = $this->config->get('config_open');
                ...
                if (isset($this->request->post['config_image_contact'])) {
			$data['config_image_contact'] = $this->request->post['config_image_contact'];
		} else {
			$data['config_image_contact'] = $this->config->get('config_image_contact');
		}
                
                if (isset($this->request->post['config_image_contact']) && is_file(DIR_IMAGE . $this->request->post['config_image_contact'])) {
			$data['thumb_contact'] = $this->model_tool_image->resize($this->request->post['config_image_contact'], 100, 100);
		} elseif ($this->config->get('config_image_contact') && is_file(DIR_IMAGE . $this->config->get('config_image_contact'))) {
			$data['thumb_contact'] = $this->model_tool_image->resize($this->config->get('config_image_contact'), 100, 100);
		} else {
			$data['thumb_contact'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_comment'])) {
			...
			$data['config_comment'] = $this->config->get('config_comment');
                ...
                if (isset($this->request->post['config_social_email'])) {
			$data['config_social_email'] = $this->request->post['config_social_email'];
		} else {
			$data['config_social_email'] = $this->config->get('config_social_email');
		}
			...
			$data['config_social_linkedin'] = $this->config->get('config_social_linkedin');
                ...
                if (isset($this->request->post['config_social_wordpress'])) {
			$data['config_social_wordpress'] = $this->request->post['config_social_wordpress'];
		} else {
			$data['config_social_wordpress'] = $this->config->get('config_social_wordpress');
		}
                
                if (isset($this->request->post['config_header_tag'])) {
			$data['config_header_tag'] = $this->request->post['config_header_tag'];
		} else {
			$data['config_header_tag'] = $this->config->get('config_header_tag');
		}
                
                if (isset($this->request->post['config_footer_tag'])) {
			$data['config_footer_tag'] = $this->request->post['config_footer_tag'];
		} else {
			$data['config_footer_tag'] = $this->config->get('config_footer_tag');
		}
                
                if (isset($this->request->post['config_header_tag_size'])) {
			$data['config_header_tag_size'] = $this->request->post['config_header_tag_size'];
		} else {
			$data['config_header_tag_size'] = $this->config->get('config_header_tag_size');
		}
		...
		if (isset($this->request->post['config_meta_description'])) {
			...
			$data['config_meta_description'] = $this->config->get('config_meta_description');
                ...
                if (isset($this->request->post['config_image_hw_s1'])) {
			$data['config_image_hw_s1'] = $this->request->post['config_image_hw_s1'];
		} else {
			$data['config_image_hw_s1'] = $this->config->get('config_image_hw_s1');
		}
                
                if (isset($this->request->post['config_image_hw_s1']) && is_file(DIR_IMAGE . $this->request->post['config_image_hw_s1'])) {
			$data['thumb_hw_s1'] = $this->model_tool_image->resize($this->request->post['config_image_hw_s1'], 100, 100);
		} elseif ($this->config->get('config_image_hw_s1') && is_file(DIR_IMAGE . $this->config->get('config_image_hw_s1'))) {
			$data['thumb_hw_s1'] = $this->model_tool_image->resize($this->config->get('config_image_hw_s1'), 100, 100);
		} else {
			$data['thumb_hw_s1'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
                
                
                if (isset($this->request->post['config_image_hw_s2'])) {
			$data['config_image_hw_s2'] = $this->request->post['config_image_hw_s2'];
		} else {
			$data['config_image_hw_s2'] = $this->config->get('config_image_hw_s2');
		}
                
                if (isset($this->request->post['config_image_hw_s2']) && is_file(DIR_IMAGE . $this->request->post['config_image_hw_s2'])) {
			$data['thumb_hw_s2'] = $this->model_tool_image->resize($this->request->post['config_image_hw_s2'], 100, 100);
		} elseif ($this->config->get('config_image_hw_s2') && is_file(DIR_IMAGE . $this->config->get('config_image_hw_s2'))) {
			$data['thumb_hw_s2'] = $this->model_tool_image->resize($this->config->get('config_image_hw_s2'), 100, 100);
		} else {
			$data['thumb_hw_s2'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
                
                if (isset($this->request->post['config_image_hw_s3'])) {
			$data['config_image_hw_s3'] = $this->request->post['config_image_hw_s3'];
		} else {
			$data['config_image_hw_s3'] = $this->config->get('config_image_hw_s3');
		}
                
                if (isset($this->request->post['config_image_hw_s3']) && is_file(DIR_IMAGE . $this->request->post['config_image_hw_s3'])) {
			$data['thumb_hw_s3'] = $this->model_tool_image->resize($this->request->post['config_image_hw_s3'], 100, 100);
		} elseif ($this->config->get('config_image_hw_s3') && is_file(DIR_IMAGE . $this->config->get('config_image_hw_s3'))) {
			$data['thumb_hw_s3'] = $this->model_tool_image->resize($this->config->get('config_image_hw_s3'), 100, 100);
		} else {
			$data['thumb_hw_s3'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
                
                if (isset($this->request->post['config_image_hw_s4'])) {
			$data['config_image_hw_s4'] = $this->request->post['config_image_hw_s4'];
		} else {
			$data['config_image_hw_s4'] = $this->config->get('config_image_hw_s4');
		}
                
                if (isset($this->request->post['config_image_hw_s4']) && is_file(DIR_IMAGE . $this->request->post['config_image_hw_s4'])) {
			$data['thumb_hw_s4'] = $this->model_tool_image->resize($this->request->post['config_image_hw_s4'], 100, 100);
		} elseif ($this->config->get('config_image_hw_s4') && is_file(DIR_IMAGE . $this->config->get('config_image_hw_s4'))) {
			$data['thumb_hw_s4'] = $this->model_tool_image->resize($this->config->get('config_image_hw_s4'), 100, 100);
		} else {
			$data['thumb_hw_s4'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
                
                if (isset($this->request->post['config_hw_s1_title'])) {
			$data['config_hw_s1_title'] = $this->request->post['config_hw_s1_title'];
		} else {
			$data['config_hw_s1_title'] = $this->config->get('config_hw_s1_title');
		}
                
                if (isset($this->request->post['config_hw_s2_title'])) {
			$data['config_hw_s2_title'] = $this->request->post['config_hw_s2_title'];
		} else {
			$data['config_hw_s2_title'] = $this->config->get('config_hw_s2_title');
		}
                
                if (isset($this->request->post['config_hw_s3_title'])) {
			$data['config_hw_s3_title'] = $this->request->post['config_hw_s3_title'];
		} else {
			$data['config_hw_s3_title'] = $this->config->get('config_hw_s3_title');
		}
                
                if (isset($this->request->post['config_hw_s4_title'])) {
			$data['config_hw_s4_title'] = $this->request->post['config_hw_s4_title'];
		} else {
			$data['config_hw_s4_title'] = $this->config->get('config_hw_s4_title');
		}
                
                if (isset($this->request->post['config_hw_s1_detail'])) {
			$data['config_hw_s1_detail'] = $this->request->post['config_hw_s1_detail'];
		} else {
			$data['config_hw_s1_detail'] = $this->config->get('config_hw_s1_detail');
		}
                
                if (isset($this->request->post['config_hw_s2_detail'])) {
			$data['config_hw_s2_detail'] = $this->request->post['config_hw_s2_detail'];
		} else {
			$data['config_hw_s2_detail'] = $this->config->get('config_hw_s2_detail');
		}
                
                if (isset($this->request->post['config_hw_s3_detail'])) {
			$data['config_hw_s3_detail'] = $this->request->post['config_hw_s3_detail'];
		} else {
			$data['config_hw_s3_detail'] = $this->config->get('config_hw_s3_detail');
		}
                
                if (isset($this->request->post['config_hw_s4_detail'])) {
			$data['config_hw_s4_detail'] = $this->request->post['config_hw_s4_detail'];
		} else {
			$data['config_hw_s4_detail'] = $this->config->get('config_hw_s4_detail');
		}
                
                
                if (isset($this->request->post['config_btn_supplier_signup'])) {
			$data['config_btn_supplier_signup'] = $this->request->post['config_btn_supplier_signup'];
		} else {
			$data['config_btn_supplier_signup'] = $this->config->get('config_btn_supplier_signup');
		}
                
                if (isset($this->request->post['config_mem_package_offer'])) {
			$data['config_mem_package_offer'] = $this->request->post['config_mem_package_offer'];
		} else {
			$data['config_mem_package_offer'] = $this->config->get('config_mem_package_offer');
		}
                
                if (isset($this->request->post['config_mem_offer_discount'])) {
			$data['config_mem_offer_discount'] = $this->request->post['config_mem_offer_discount'];
		} else {
			$data['config_mem_offer_discount'] = $this->config->get('config_mem_offer_discount');
		}
                
                if (isset($this->request->post['config_mem_package_title'])) {
			$data['config_mem_package_title'] = $this->request->post['config_mem_package_title'];
		} else {
			$data['config_mem_package_title'] = $this->config->get('config_mem_package_title');
		}
                
                if (isset($this->request->post['config_mem_package_btn'])) {
			$data['config_mem_package_btn'] = $this->request->post['config_mem_package_btn'];
		} else {
			$data['config_mem_package_btn'] = $this->config->get('config_mem_package_btn');
		}
                
                if (isset($this->request->post['config_mem_signup_btn'])) {
			$data['config_mem_signup_btn'] = $this->request->post['config_mem_signup_btn'];
		} else {
			$data['config_mem_signup_btn'] = $this->config->get('config_mem_signup_btn');
		}
                
                if (isset($this->request->post['config_mem_pay_email'])) {
			$data['config_mem_pay_email'] = $this->request->post['config_mem_pay_email'];
		} else {
			$data['config_mem_pay_email'] = $this->config->get('config_mem_pay_email');
		}
                
                if (isset($this->request->post['config_mem_pay_sandbox'])) {
			$data['config_mem_pay_sandbox'] = $this->request->post['config_mem_pay_sandbox'];
		} else {
			$data['config_mem_pay_sandbox'] = $this->config->get('config_mem_pay_sandbox');
		}
                
                if (isset($this->request->post['config_mem_pay_thanks'])) {
			$data['config_mem_pay_thanks'] = $this->request->post['config_mem_pay_thanks'];
		} else {
			$data['config_mem_pay_thanks'] = $this->config->get('config_mem_pay_thanks');
		}
                
                if (isset($this->request->post['config_mem_pay_thanks_detail'])) {
			$data['config_mem_pay_thanks_detail'] = $this->request->post['config_mem_pay_thanks_detail'];
		} else {
			$data['config_mem_pay_thanks_detail'] = $this->config->get('config_mem_pay_thanks_detail');
		}
                
                
                if (isset($this->request->post['config_btn_product_quote'])) {
			$data['config_btn_product_quote'] = $this->request->post['config_btn_product_quote'];
		} else {
			$data['config_btn_product_quote'] = $this->config->get('config_btn_product_quote');
		}
                if (isset($this->request->post['config_btn_supplier_enq'])) {
			$data['config_btn_supplier_enq'] = $this->request->post['config_btn_supplier_enq'];
		} else {
			$data['config_btn_supplier_enq'] = $this->config->get('config_btn_supplier_enq');
		}
                
                if (isset($this->request->post['config_quote_alert_option'])) {
			$data['config_quote_alert_option'] = $this->request->post['config_quote_alert_option'];
		} else {
			$data['config_quote_alert_option'] = $this->config->get('config_quote_alert_option');
		}
                
                if (isset($this->request->post['config_quote_alert_title'])) {
			$data['config_quote_alert_title'] = $this->request->post['config_quote_alert_title'];
		} else {
			$data['config_quote_alert_title'] = $this->config->get('config_quote_alert_title');
		}
                
                if (isset($this->request->post['config_quote_alert_detail'])) {
			$data['config_quote_alert_detail'] = $this->request->post['config_quote_alert_detail'];
		} else {
			$data['config_quote_alert_detail'] = $this->config->get('config_quote_alert_detail');
		}
                
                if (isset($this->request->post['config_promote_title'])) {
			$data['config_promote_title'] = $this->request->post['config_promote_title'];
		} else {
			$data['config_promote_title'] = $this->config->get('config_promote_title');
		}
                
                if (isset($this->request->post['config_promote_how_works'])) {
			$data['config_promote_how_works'] = $this->request->post['config_promote_how_works'];
		} else {
			$data['config_promote_how_works'] = $this->config->get('config_promote_how_works');
		}
                
                if (isset($this->request->post['config_promote_step_1_title'])) {
			$data['config_promote_step_1_title'] = $this->request->post['config_promote_step_1_title'];
		} else {
			$data['config_promote_step_1_title'] = $this->config->get('config_promote_step_1_title');
		}
                
                if (isset($this->request->post['config_promote_step_1_detail'])) {
			$data['config_promote_step_1_detail'] = $this->request->post['config_promote_step_1_detail'];
		} else {
			$data['config_promote_step_1_detail'] = $this->config->get('config_promote_step_1_detail');
		}
                
                if (isset($this->request->post['config_promote_step_1_icon'])) {
			$data['config_promote_step_1_icon'] = $this->request->post['config_promote_step_1_icon'];
		} else {
			$data['config_promote_step_1_icon'] = $this->config->get('config_promote_step_1_icon');
		}
                
                
                if (isset($this->request->post['config_promote_step_2_title'])) {
			$data['config_promote_step_2_title'] = $this->request->post['config_promote_step_2_title'];
		} else {
			$data['config_promote_step_2_title'] = $this->config->get('config_promote_step_2_title');
		}
                
                if (isset($this->request->post['config_promote_step_2_detail'])) {
			$data['config_promote_step_2_detail'] = $this->request->post['config_promote_step_2_detail'];
		} else {
			$data['config_promote_step_2_detail'] = $this->config->get('config_promote_step_2_detail');
		}
                
                if (isset($this->request->post['config_promote_step_2_icon'])) {
			$data['config_promote_step_2_icon'] = $this->request->post['config_promote_step_2_icon'];
		} else {
			$data['config_promote_step_2_icon'] = $this->config->get('config_promote_step_2_icon');
		}
                
                if (isset($this->request->post['config_promote_step_3_title'])) {
			$data['config_promote_step_3_title'] = $this->request->post['config_promote_step_3_title'];
		} else {
			$data['config_promote_step_3_title'] = $this->config->get('config_promote_step_3_title');
		}
                
                if (isset($this->request->post['config_promote_step_3_detail'])) {
			$data['config_promote_step_3_detail'] = $this->request->post['config_promote_step_3_detail'];
		} else {
			$data['config_promote_step_3_detail'] = $this->config->get('config_promote_step_3_detail');
		}
                
                if (isset($this->request->post['config_promote_step_3_icon'])) {
			$data['config_promote_step_3_icon'] = $this->request->post['config_promote_step_3_icon'];
		} else {
			$data['config_promote_step_3_icon'] = $this->config->get('config_promote_step_3_icon');
		}
                
                if (isset($this->request->post['config_promote_step_4_title'])) {
			$data['config_promote_step_4_title'] = $this->request->post['config_promote_step_4_title'];
		} else {
			$data['config_promote_step_4_title'] = $this->config->get('config_promote_step_4_title');
		}
                
                if (isset($this->request->post['config_promote_step_4_detail'])) {
			$data['config_promote_step_4_detail'] = $this->request->post['config_promote_step_4_detail'];
		} else {
			$data['config_promote_step_4_detail'] = $this->config->get('config_promote_step_4_detail');
		}
                
                if (isset($this->request->post['config_promote_step_4_icon'])) {
			$data['config_promote_step_4_icon'] = $this->request->post['config_promote_step_4_icon'];
		} else {
			$data['config_promote_step_4_icon'] = $this->config->get('config_promote_step_4_icon');
		}
                
                if (isset($this->request->post['config_promote_membership'])) {
			$data['config_promote_membership'] = $this->request->post['config_promote_membership'];
		} else {
			$data['config_promote_membership'] = $this->config->get('config_promote_membership');
		}
                
                if (isset($this->request->post['config_promote_membership_detail'])) {
			$data['config_promote_membership_detail'] = $this->request->post['config_promote_membership_detail'];
		} else {
			$data['config_promote_membership_detail'] = $this->config->get('config_promote_membership_detail');
		}
                
                if (isset($this->request->post['config_promote_get_started'])) {
			$data['config_promote_get_started'] = $this->request->post['config_promote_get_started'];
		} else {
			$data['config_promote_get_started'] = $this->config->get('config_promote_get_started');
		}
                
                if (isset($this->request->post['config_promote_contact'])) {
			$data['config_promote_contact'] = $this->request->post['config_promote_contact'];
		} else {
			$data['config_promote_contact'] = $this->config->get('config_promote_contact');
		}
                
                
                if (isset($this->request->post['config_image_promote'])) {
			$data['config_image_promote'] = $this->request->post['config_image_promote'];
		} else {
			$data['config_image_promote'] = $this->config->get('config_image_promote');
		}
                
                if (isset($this->request->post['config_image_promote']) && is_file(DIR_IMAGE . $this->request->post['config_image_promote'])) {
			$data['thumb_promote'] = $this->model_tool_image->resize($this->request->post['config_image_promote'], 100, 100);
		} elseif ($this->config->get('config_image_promote') && is_file(DIR_IMAGE . $this->config->get('config_image_promote'))) {
			$data['thumb_promote'] = $this->model_tool_image->resize($this->config->get('config_image_promote'), 100, 100);
		} else {
			$data['thumb_promote'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_account_id_terms'])) {
			$data['config_account_id_terms'] = $this->request->post['config_account_id_terms'];
		} else {
			$data['config_account_id_terms'] = $this->config->get('config_account_id_terms');
		}
