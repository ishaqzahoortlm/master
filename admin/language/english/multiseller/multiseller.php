...
$_['ms_error_product_publish'] = 'Failed to publish some products: supplier account not active.';
...
$_['text_seller_select'] = 'Supplier select';
...
$_['ms_none'] = 'None';
$_['ms_seller'] = 'Supplier';
$_['ms_all_sellers'] = 'All suppliers';
$_['ms_amount'] = 'Amount';
...
$_['ms_menu_sellers'] = 'Suppliers';
$_['ms_menu_seller_groups'] = 'Supplier groups';
...
$_['ms_config_seller_validation'] = 'Supplier validation';
$_['ms_config_seller_validation_note'] = 'Supplier validation';
...
$_['ms_config_allow_inactive_seller_products'] = 'Allow inactive suppliers to list products';
$_['ms_config_allow_inactive_seller_products_note'] = 'Allows inactive suppliers to list new products, which will be inactive. After approval of such seller all his products will become active at once.';
...
$_['ms_config_allow_relisting_note'] = 'Suppliers will be able to re-list the products, which have been disabled (useful if you use product limitation by period or quantity in combination with listing fees)';

$_['ms_config_enable_banner'] = 'Enable supplier banners';
$_['ms_config_enable_banner_note'] = 'Allow suppliers to upload a banner that will be displayed on their profile page';

$_['ms_config_enable_one_page_seller_registration'] = 'One-page registration';
$_['ms_config_enable_one_page_seller_registration_note'] = 'Enable supplier one-page registration';
...
$_['ms_config_credit_order_statuses_note'] = 'Supplier balance will be funded for orders with fund statuses';

$_['ms_config_debit_order_statuses'] = 'Charge statuses';
$_['ms_config_debit_order_statuses_note'] = 'Supplier balance will be charged for orders with charge statuses';

$_['ms_config_display_order_statuses'] = 'Display order statuses';
$_['ms_config_display_order_statuses_note'] = 'Order statuses that aren\'t selected here will not be visible to suppliers';
...
$_['ms_config_allow_partial_withdrawal_note'] = 'Allow suppliers to request partial payouts';

$_['ms_config_allow_withdrawal_requests'] = 'Allow payout requests';
$_['ms_config_allow_withdrawal_requests_note'] = 'Allow suppliers to request earnings';
...
$_['ms_config_allow_free_products_note'] = 'Allow suppliers to add free products';

$_['ms_config_allow_multiple_categories'] = 'Allow multiple categories';
$_['ms_config_allow_multiple_categories_note'] = 'Allow suppliers to add products to multiple categories';

$_['ms_config_additional_category_restrictions'] = 'Bulk disallow categories';
$_['ms_config_additional_category_restrictions_note'] = '<u>Disallow</u> suppliers to list products in specific categories';
...
$_['ms_config_restrict_categories_note'] = '<u>Disallow</u> suppliers to list products in these categories';
...
$_['ms_config_enable_quantities_note'] = 'Allow suppliers to specify quantities for products';

$_['ms_config_seller_terms_page'] = 'Supplier account terms';
$_['ms_config_seller_terms_page_note'] = 'Suppliers have to agree to the terms when creating a supplier account.';

$_['ms_config_allow_specials'] = 'Allow special prices';
$_['ms_config_allow_specials_note'] = 'Allow suppliers to define special prices';

$_['ms_config_allow_discounts'] = 'Allow quantity discounts';
$_['ms_config_allow_discounts_note'] = 'Allow suppliers to define quantity discounts';
 
$_['ms_config_withdrawal_waiting_period'] = 'Payout waiting period';
$_['ms_config_withdrawal_waiting_period_note'] = 'Supplier balance entries newer than this value will not be available for payout requests';

$_['ms_config_graphical_sellermenu'] = 'Graphical supplier menu';
$_['ms_config_graphical_sellermenu_note'] = 'Graphical supplier menu';
...
$_['ms_config_enable_rte_note'] = 'Enable Summernote Rich Text Editor for product and supplier description fields.';
...
$_['ms_config_seller_avatar_image_size_seller_profile'] = 'Supplier profile';
$_['ms_config_seller_avatar_image_size_seller_list'] = 'Supplier list';
$_['ms_config_seller_avatar_image_size_product_page'] = 'Product page';
$_['ms_config_seller_avatar_image_size_seller_dashboard'] = 'Supplier dashboard';
$_['ms_config_seller_banner_size'] = 'Seller banner size';

$_['ms_config_image_preview_size'] = 'Image preview size';
$_['ms_config_image_preview_size_seller_avatar'] = 'Supplier avatar';
$_['ms_config_image_preview_size_product_image'] = 'Product image';

$_['ms_config_product_image_size'] = 'Product image size';
$_['ms_config_product_image_size_seller_profile'] = 'Supplier profile';
...
$_['ms_config_seo'] = 'SEO';
$_['ms_config_enable_seo_urls_seller'] = 'Generate SEO URLs for new suppliers';
$_['ms_config_enable_seo_urls_seller_note'] = 'This option will generate SEO-friendly URLs for new suppliers. SEO URLs need to be enabled in OpenCart to use this.';
...
$_['ms_config_sellers_slug'] = 'Suppliers SEO keyword';
$_['ms_config_sellers_slug_note'] = 'Suppliers list SEO keyword (will work only if SEO is enabled)';
...
$_['ms_config_enable_private_messaging'] = 'Allow customers to contact suppliers';
$_['ms_config_enable_private_messaging_note'] = 'Enables or disables the supplier contact dialog';

$_['ms_config_hide_customer_email'] = 'Hide customer email address';
$_['ms_config_hide_customer_email_note'] = 'Hides customer email address in the supplier dashboard and in orders list';
$_['ms_config_hide_email_in_email'] = 'Hide email addresses in emails';
$_['ms_config_hide_email_in_email_note'] = 'Hides customer and supplier email addresses in the emails sent by MultiMerch';

$_['ms_config_seller'] = 'Suppliers';

// Change Seller Nickname
$_['ms_config_seller_change_nickname'] = 'Allow nickname change';
$_['ms_config_seller_change_nickname_note'] = 'Allow suppliers to change nickname/shop name';

// Seller Nickname Rules
$_['ms_config_nickname_rules'] = 'Supplier nickname rules';
$_['ms_config_nickname_rules_note'] = 'Character sets allowed in supplier nicknames';
...
// Seller Avatars
$_['ms_config_avatars_for_sellers'] = 'Avatars for suppliers';
$_['ms_config_avatars_for_sellers_note'] = 'Define the way supplier avatars work';
$_['ms_config_avatars_manually'] = 'Uploaded manually by supplier';
$_['ms_config_avatars_both'] = 'Both uploaded by supplier and pre-defined';
$_['ms_config_avatars_predefined'] = 'Only pre-defined';

$_['ms_config_other'] = 'Other';
$_['ms_config_hide_sellers_product_count'] = 'Hide count of suppliers and products in the header';
$_['ms_config_hide_sellers_product_count_note'] = 'Hides line, which contains count of suppliers and products in the header';

// Seller - List
$_['ms_catalog_sellers_heading'] = 'Suppliers';
$_['ms_catalog_sellers_breadcrumbs'] = 'Suppliers';
$_['ms_catalog_sellers_newseller'] = 'New supplier';
$_['ms_catalog_sellers_create'] = 'Create new supplier';

$_['ms_catalog_sellers_total_balance'] = 'Total amount on all balances: <b>%s</b> (active suppliers: <b>%s</b>)';
...
$_['ms_seller_change'] = 'Change supplier';
...
$_['ms_catalog_sellerinfo_heading'] = 'Supplier';
$_['ms_catalog_sellerinfo_seller_data'] = 'Supplier data';
...
$_['ms_catalog_sellerinfo_sellergroup'] = 'Supplier group';
...
$_['ms_catalog_sellerinfo_notify'] = 'Notify supplier via email';
$_['ms_catalog_sellerinfo_product_validation'] = 'Product validation';
$_['ms_catalog_sellerinfo_product_validation_note'] = 'Product validation for this supplier';
...
$_['ms_catalog_products_notify_sellers'] = 'Notify Suppliers';
$_['ms_catalog_products_bulk'] = '--Bulk status change--';
$_['ms_catalog_products_noseller'] = '--No supplier--';
...
$_['ms_catalog_seller_groups_heading'] = 'Supplier groups';
$_['ms_catalog_seller_groups_breadcrumbs'] = 'Supplier Groups';

$_['ms_seller_groups_column_id'] = 'ID';
$_['ms_seller_groups_column_name'] = 'Name';
$_['ms_seller_groups_column_action'] = 'Actions';

$_['ms_catalog_insert_seller_group_heading'] = 'New Supplier Group';
$_['ms_catalog_edit_seller_group_heading'] = 'Edit Supplier Group';
...
$_['ms_error_seller_group_default'] = 'Error: Default supplier group can not be deleted!';
$_['ms_success_seller_group_created'] = 'Supplier group created';
$_['ms_success_seller_group_updated'] = 'Supplier group updated';
...
$_['ms_error_payment_fromto'] = 'Only store to supplier and supplier to store payments are supported.';
$_['ms_error_payment_fromstore'] = 'Outgoing payments (store to supplier) can only be of types Payout or Payout request';
$_['ms_error_payment_tostore'] = 'Incoming payments (supplier to store) can not be of types Payout or Payout request';
$_['ms_error_payment_amount'] = 'Please specify a valid payment amount';
$_['ms_error_payment_norequests'] = 'Error: no valid payouts to process. Please make sure the suppliers have enough funds and valid PayPal addresses specified';
...
$_['ms_error_transaction_fromto'] = 'Please specify at least the source or the destination supplier';
...
$_['ms_mail_subject_seller_account_modified'] = 'Supplier account modified';
...
$_['ms_payment_method_balance'] = 'Supplier balance';
