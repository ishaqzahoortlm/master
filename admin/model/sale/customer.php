                        ...
                        */
                        $message ='<tr>
                                        <td style="line-height:22px;">
                                         ...
                                         <p>'.sprintf($this->language->get('text_approve_welcome'), $store_name).'</p>       
                                         <br/>
                                         <p>'.$this->language->get('text_approve_login').'</p> 
                                         <p>'.$store_url.'</p>
                                         <p>'.$this->language->get('text_approve_services').'</p>
                                         <p>'.$this->language->get('text_approve_thanks').'</p>
                                         <p>'.$store_name.'</p>    
                                        </td>
                                </tr>';
