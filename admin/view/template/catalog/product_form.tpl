                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-data">
                            ...
                            <div class="form-group" id="id_other_cert" style="display:none;">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="certification_other" id="certification_other" value="" placeholder="Certification"  class="form-control" />
                                    ...
                                    <div class="col-sm-2">
                                        <ul class="nav nav-pills nav-stacked" id="option">
                                            ...
                                            <li><a href="#tab-option<?php echo $option_row; ?>" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$('a[href=\'#tab-option<?php echo $option_row; ?>\']').parent().remove();
                                                    ...
                                                    $('#option a:first').tab('show');"></i> <?php echo $product_option['name']; ?></a></li>
                                            <?php $option_row++; ?>
                                            <?php } ?>
                                            <li>
