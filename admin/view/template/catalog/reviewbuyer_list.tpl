              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($review['review_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><a href="<?=$review['order_detail']?>" target="_blank" ><?php echo $review['order_id']; ?></a></td>
                  <td class="text-left"><?php echo $review['buyer']; ?></td>
                  <td class="text-right"><?php echo $review['seller']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=catalog/reviewbuyer&token=<?php echo $token; ?>';
