<ul id="menu">
    ...
    <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
        <ul>
            ...
            <li><a href="<?php echo $review_buyer; ?>"><?php echo $text_buyer_review; ?></a></li> 
            <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
            <li><a href="<?= $this->url->link('module/featured', 'token=' . $this->session->data['token'] . '&module_id=28', 'SSL') ?>">Featured Products</a></li>

        </ul>
    </li>

    <li  id="faq"><a class="parent"><i class="fa fa-file-o fa-fw"></i> <span><?php echo $text_faq; ?></span></a>
        <ul>

            <li><a href="<?php echo $groupfaq; ?>"><?php echo $text_group_faq; ?></a></li>
            <li><a href="<?php echo $faq; ?>"><?php echo $text_faq; ?></a></li>
        </ul>
    </li>
    <li id="news"><a href="<?php echo $custom_news; ?>"><i class="fa fa-file fa-fw"></i> <span><?php echo $text_custome_news; ?></span></a></li>
    <li id="package"><a href="<?php echo $custom_package; ?>"><i class="fa fa-dot-circle-o fa-fw"></i> <span><?php echo $text_custome_package; ?></span></a></li>
    <li id="certification"><a href="<?php echo $custom_certification; ?>"><i class="fa fa-file-text fa-fw"></i> <span><?php echo $text_custome_certifications; ?></span></a></li>
    ...
    <li id="system"><a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_system; ?></span></a>
        <ul>
            ...
            <li><a href="<?php echo $banner; ?>" class="parent"><?php echo $text_banner; ?></a></li>
            <li><a href="<?php echo $custom_email; ?>" class="parent"><?php echo $text_emails; ?></a></li>
    ...
    <!--<li id="multimerch"><a class="parent"><i class="fa fa-users fa-fw"></i> <span><?php //echo $ms_menu_multiseller; ?></span></a>
        <ul>
            ...
            <li><a href="<?php //echo $this->url->link('multiseller/messages', 'token=' . $this->session->data['token'], 'SSL'); ?>">Messages</a></li>
