        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
			  ...
			  <tbody>
				<?php if ($all_certification) { ?>
				  <?php foreach ($all_certification as $certification) { ?>
				  <tr>
					<td width="1" style="text-align: center;"><input type="checkbox" name="selected[]" value="<?php echo $certification['certification_id']; ?>" /></td>
					<td class="text-left"><?php echo $certification['title']; ?></td>
					<td class="text-right"><a class="btn btn-primary" href="<?php echo $certification['edit']; ?>"><i class="fa fa-pencil"></i></a> </td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
