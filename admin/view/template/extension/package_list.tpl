            ...
            <table class="table table-bordered table-striped table-hover">
			  <thead>
				<tr>
				  ...
				  <td class="text-left"><?php echo $text_price; ?></td>
                                  <td class="text-left"><?php echo $text_trial; ?></td>
			  ...
			  <tbody>
				<?php if ($all_package) { ?>
				  ...
				  <tr>
					<td width="1" style="text-align: center;"><input type="checkbox" name="selected[]" value="<?php echo $package['package_id']; ?>" /></td>
					<td class="text-left"><?php echo $package['title']; ?></td>
					<td class="text-left"><?php echo $package['price']; ?></td>
                                        <td class="text-left"><?php echo ($package['trial']==1)?'Yes':'No'; ?></td>
					<td class="text-right"><a class="btn btn-primary" href="<?php echo $package['edit']; ?>"><i class="fa fa-pencil"></i></a> </td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
