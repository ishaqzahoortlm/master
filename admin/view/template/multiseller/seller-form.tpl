        ...
        <form id="ms-sellerinfo" class="form-horizontal">
            ...
            <legend><?php echo $ms_catalog_sellerinfo_customer_data; ?></legend>
             <div class="form-group required">
                ...
                <?php } else { ?>
                <a class="label label-info" style="margin-top: 5px;" href="<?php echo $this->url->link('sale/customer/edit', 'token=' . $this->session->data['token'] . '&customer_id=' . $seller['seller_id'], 'SSL'); ?>"><?php echo $seller['name']; ?></a>
                <?php } ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="seller[featured]">
                        <option value="1" <?=($seller['ms.featured']==1)?'selected':''?> ><?php echo $text_yes; ?></option>
                            <option value="0" <?=($seller['ms.featured']==0)?'selected':''?> ><?php echo $text_no; ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Current Package</label>
                <div class="col-sm-10">
                    <select class="form-control" name="seller[package_id]">
                        <option value="0">Select</option>
                        <?php foreach ($all_package as $package) { ?>
                        <option value="<?php echo $package['package_id']; ?>" <?php if ($seller['ms.package_id'] == $package['package_id']) { ?>selected="selected"<?php } ?>><?=$package['title']?></option>
                    <?php } ?>
                    </select>
                </div>
            </div>
