    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<table class="list mmTable table table-bordered table-hover" style="text-align: center" id="list-sellers">
			<thead>
				<tr>
                                    <td class="tiny" style="display: none;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
					<td class="medium"><?php echo $ms_seller; ?></td>
					<td class="medium"><?php echo $ms_catalog_sellers_email; ?></td>
					...
					<td class="tiny"><?php echo $ms_catalog_sellers_status; ?></td>
                                        <td class="tiny">Featured</td>
					<td class="medium"><?php echo $ms_catalog_sellers_date_created; ?></td>
					<td class="medium"><?php echo $ms_action; ?></td>
				</tr>
				<tr class="filter">
					<td style="display: none;"></td>
					<td><input type="text" class="form-control" name="search_seller" class="search_init" /></td>
					<td><input type="text" class="form-control" name="filter_email" /></td>
					<td><input type="text" class="form-control" name="filter_total_products" /></td>
					<td><input type="text" class="form-control" name="filter_total_sales" /></td>
					<td><input type="text" class="form-control" name="filter_total_earnings" /></td>
					<td><input type="text" class="form-control" name="filter_balance" /></td>
					<td></td>
                                        <td></td>
					<td><input type="text" class="form-control" name="filter_date_created" /></td>
					<td></td>
				</tr>
			</thead>
			<tbody>
