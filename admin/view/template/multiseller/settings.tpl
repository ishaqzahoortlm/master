                ...
                <div class="tab-content">
			 	...
			 	<div class="tab-pane active" id="tab-general">
					...
					-->
						...
						<div class="col-sm-10">
							<select class="form-control" name="msconf_seller_terms_use_page">
								<option value="0"><?php echo $text_none; ?></option>
								<?php foreach ($informations as $information) { ?>
								<?php if ($information['information_id'] == $msconf_seller_terms_use_page) { ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Sellers have to agree to the policy when creating a seller account.">Seller account policy</span></label>
						<div class="col-sm-10">
					...
					<div class="form-group" style="display: none;">
						...
						<div class="col-sm-10">
							<label class="radio-inline"><input type="radio" name="msconf_graphical_sellermenu" value="1"   /><?php echo $text_yes; ?>
							</label>
							<label class="radio-inline"><input type="radio" name="msconf_graphical_sellermenu" value="0" checked  /><?php echo $text_no; ?>
							</label>
						</div>
					</div>
				...
				<!-- END GENERAL TAB -->
			 	...
			 	<div class="tab-pane" id="tab-productform">
					<div class="form-group">
						...
						<div class="col-sm-10">
                                                        <?php $msconf_allow_free_products = 1 ?>
