...
<div id="content">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab-promote" data-toggle="tab">Promote</a></li>
                        <li><a href="#tab-buttons" data-toggle="tab">Buttons</a></li>
                        <li><a href="#tab-how_works" data-toggle="tab">How it works</a></li>
                        <li><a href="#tab-membership" data-toggle="tab">Membership Plans</a></li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Header Subtitle</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="config_header_tag" id="config_header_tag" value="<?=$config_header_tag?>" >

                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Subtitle text size</span></label>
                                <div class="col-sm-2">
                                    <select class="form-control" name="config_header_tag_size" id="config_header_tag_size"  >
                                        <?php for($i=12;$i<=28;$i++){ ?>
                                        <option value="<?=$i?>" <?=($config_header_tag_size==$i)?'selected':''?>><?=$i?>px</option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image_contact">Contact Image</label>
                                <div class="col-sm-10"><a href="" id="thumb-image_contact" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_contact; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="config_image_contact" value="<?php echo $config_image_contact; ?>" id="input-image_contact" />
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Footer Subtitle</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="config_footer_tag" id="config_header_tag" value="<?=$config_footer_tag?>" >
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-social_facebook">Facebook</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="config_social_facebook" id="config_social_facebook" value="<?=$config_social_facebook?>" >

                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-social_twitter">Twitter</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="config_social_twitter" id="config_social_twitter" value="<?=$config_social_twitter?>" >

                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-social_linkedin">Wordpress</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="config_social_wordpress" id="config_social_wordpress" value="<?=$config_social_wordpress?>" >

                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-social_linkedin">Linkedin</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="config_social_linkedin" id="config_social_linkedin" value="<?=$config_social_linkedin?>" >

                                    </div>
                                </div>
                                <div class="form-group" style="display: none;">
                                    <label class="col-sm-2 control-label" for="input-social_email">Behance</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="config_social_email" id="config_social_email" value="<?=$config_social_email?>" >
                        ...
                        <div class="tab-pane" id="tab-promote">
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Page Title</label>
                                <div class="col-sm-10">
                                    <input name="config_promote_title" placeholder="Page Title" id="config_promote_title" class="form-control" value="<?php echo $config_promote_title; ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image_promote">Image</label>
                                <div class="col-sm-10"><a href="" id="thumb-image_promote" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_promote; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="config_image_promote" value="<?php echo $config_image_promote; ?>" id="input-image_promote" />
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >How it Works</label>
                                <div class="col-sm-10">
                                    <input name="config_promote_how_works" placeholder="How it Works" id="config_promote_how_works" class="form-control" value="<?php echo $config_promote_how_works; ?>">
                                </div>
                            </div>
                            <h4><b>Step 1</b></h4>
                            <hr>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="config_promote_step_1_title" placeholder="Title" id="config_promote_step_1_title" class="form-control" value="<?php echo $config_promote_step_1_title; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="config_promote_step_1_detail" placeholder="Detail" id="config_promote_step_1_detail" class="form-control" ><?php echo $config_promote_step_1_detail; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input data-placement="bottomRight" name="config_promote_step_1_icon" id="config_promote_step_1_icon"  class="form-control icp icp-auto" value="<?php echo $config_promote_step_1_icon; ?>" type="text" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Title</label>
                                <div class="col-sm-10">
                                    <input name="config_promote_step_2_title" placeholder="Title" id="config_promote_step_2_title" class="form-control" value="<?php echo $config_promote_step_2_title; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <textarea name="config_promote_step_2_detail" placeholder="Detail" id="config_promote_step_2_detail" class="form-control" ><?php echo $config_promote_step_2_detail; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input data-placement="bottomRight" name="config_promote_step_2_icon" id="config_promote_step_2_icon"  class="form-control icp icp-auto" value="<?php echo $config_promote_step_2_icon; ?>" type="text" />
                                    <span class="input-group-addon"></span>
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Title</label>
                                <div class="col-sm-10">
                                    <input name="config_promote_step_3_title" placeholder="Title" id="config_promote_step_3_title" class="form-control" value="<?php echo $config_promote_step_3_title; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <textarea name="config_promote_step_3_detail" placeholder="Detail" id="config_promote_step_3_detail" class="form-control" ><?php echo $config_promote_step_3_detail; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input data-placement="bottomRight" name="config_promote_step_3_icon" id="config_promote_step_3_icon"  class="form-control icp icp-auto" value="<?php echo $config_promote_step_3_icon; ?>" type="text" />
                                    <span class="input-group-addon"></span>
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Title</label>
                                <div class="col-sm-10">
                                    <input name="config_promote_step_4_title" placeholder="Title" id="config_promote_step_4_title" class="form-control" value="<?php echo $config_promote_step_4_title; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <textarea name="config_promote_step_4_detail" placeholder="Detail" id="config_promote_step_4_detail" class="form-control" ><?php echo $config_promote_step_4_detail; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input data-placement="bottomRight" name="config_promote_step_4_icon" id="config_promote_step_4_icon"  class="form-control icp icp-auto" value="<?php echo $config_promote_step_4_icon; ?>" type="text" />
                                    <span class="input-group-addon"></span>
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Title</label>
                                <div class="col-sm-10">
                                    <input name="config_promote_membership" placeholder="Membership" id="config_promote_membership" class="form-control" value="<?php echo $config_promote_membership; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <textarea name="config_promote_membership_detail" placeholder="Detail" id="config_promote_membership_detail" class="form-control" ><?php echo $config_promote_membership_detail; ?></textarea>
                                </div>
                            </div>
                            <hr>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Get Started</label>
                                <div class="col-sm-10">
                                    <input name="config_promote_get_started" placeholder="Get Started" id="config_promote_get_started" class="form-control" value="<?php echo $config_promote_get_started; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="config_promote_contact" placeholder="" id="config_promote_contact" class="form-control" ><?php echo $config_promote_contact; ?></textarea>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-buttons">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Supplier Signup</label>
                                <div class="col-sm-10">
                                    <input name="config_btn_supplier_signup" placeholder="" id="config_btn_supplier_signup" class="form-control" value="<?php echo $config_btn_supplier_signup ; ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Product Quote</label>
                                <div class="col-sm-10">
                                    <input name="config_btn_product_quote" placeholder="" id="config_btn_product_quote" class="form-control" value="<?php echo $config_btn_product_quote; ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Supplier Enquire</label>
                                <div class="col-sm-10">
                                    <input name="config_btn_supplier_enq" placeholder="" id="config_btn_supplier_enq" class="form-control" value="<?php echo $config_btn_supplier_enq; ?>">
                                </div>
                            </div>
                            <fieldset>
                            <legend>Product Quote Page Alert</legend>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Show Alert</label>
                                <div class="col-sm-10">
                                    <label class="control-label" >
                                        <input type="radio" name="config_quote_alert_option" id="config_quote_alert_option" <?=($config_quote_alert_option=='Yes')?'checked':''?> value="Yes"> Yes
                                    </label>
                                    <label class="control-label" >
                                    
                                        <input type="radio" name="config_quote_alert_option" id="config_quote_alert_option" <?=($config_quote_alert_option=='No')?'checked':''?> value="No"> No
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Title</label>
                                <div class="col-sm-10">
                                    <input name="config_quote_alert_title" placeholder="" id="config_quote_alert_title" class="form-control" value="<?php echo $config_quote_alert_title; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <input name="config_quote_alert_detail" placeholder="" id="config_quote_alert_detail" class="form-control" value="<?php echo $config_quote_alert_detail; ?>">
                                </div>
                            </div>
                            </fieldset>
                        </div>
                        
                        <div class="tab-pane" id="tab-how_works">
                            <fieldset>
                            <legend>Step 1</legend>
                            
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image_hw_s1">Image</label>
                                <div class="col-sm-10"><a href="" id="thumb-image_hw_s1" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_hw_s1; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="config_image_hw_s1" value="<?php echo $config_image_hw_s1; ?>" id="input-image_hw_s1" />
                                    <br/><span >Size : 131X131</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" > Title</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s1_title" placeholder="" id="config_hw_s1_title" class="form-control" value="<?php echo $config_hw_s1_title ; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s1_detail" placeholder="" id="config_hw_s1_detail" class="form-control" value="<?php echo $config_hw_s1_detail; ?>">
                                </div>
                            </div>
                            </fieldset>
                            <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image_hw_s2">Image</label>
                                <div class="col-sm-10"><a href="" id="thumb-image_hw_s2" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_hw_s2; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="config_image_hw_s2" value="<?php echo $config_image_hw_s2; ?>" id="input-image_hw_s2" />
                                    <br/><span >Size : 131X131</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Title</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s2_title" placeholder="" id="config_hw_s2_title" class="form-control" value="<?php echo $config_hw_s2_title ; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s2_detail" placeholder="" id="config_hw_s2_detail" class="form-control" value="<?php echo $config_hw_s2_detail; ?>">
                                </div>
                            </div>
                            </fieldset>
                            <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image_hw_s3">Image</label>
                                <div class="col-sm-10"><a href="" id="thumb-image_hw_s3" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_hw_s3; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="config_image_hw_s3" value="<?php echo $config_image_hw_s3; ?>" id="input-image_hw_s3" />
                                    <br/><span >Size : 131X131</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" > Title</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s3_title" placeholder="" id="config_hw_s3_title" class="form-control" value="<?php echo $config_hw_s3_title ; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" > Detail</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s3_detail" placeholder="" id="config_hw_s3_detail" class="form-control" value="<?php echo $config_hw_s3_detail; ?>">
                                </div>
                            </div>
                            </fieldset>
                            <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image_hw_s4">Image</label>
                                <div class="col-sm-10"><a href="" id="thumb-image_hw_s4" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_hw_s4; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="config_image_hw_s4" value="<?php echo $config_image_hw_s4; ?>" id="input-image_hw_s4" />
                                    <br/><span >Size : 131X131</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Title</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s4_title" placeholder="" id="config_hw_s4_title" class="form-control" value="<?php echo $config_hw_s4_title ; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Detail</label>
                                <div class="col-sm-10">
                                    <input name="config_hw_s4_detail" placeholder="" id="config_hw_s4_detail" class="form-control" value="<?php echo $config_hw_s4_detail; ?>">
                                </div>
                            </div>
                            </fieldset>
                          ...
                          <div class="tab-pane" id="tab-membership">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="config_mem_package_offer" placeholder="" id="config_mem_package_offer" class="form-control" value="<?php echo $config_mem_package_offer ; ?>">
                                </div>
                            </div>
                              
                              <div class="form-group">
                                <label class="col-sm-2 control-label" >Offer Discount</label>
                                <div class="col-sm-2">
                                    
                                <div class="input-group iconpicker-container">
                                    <input id="config_mem_offer_discount" class="form-control" type="text" value="<?=$config_mem_offer_discount?>" name="config_mem_offer_discount" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="config_mem_package_title" placeholder="" id="config_mem_package_title" class="form-control" value="<?php echo $config_mem_package_title ; ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Package Button</label>
                                <div class="col-sm-10">
                                    <input name="config_mem_package_btn" placeholder="" id="config_mem_package_btn" class="form-control" value="<?php echo $config_mem_package_btn; ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Signup Button</label>
                                <div class="col-sm-10">
                                    <input name="config_mem_signup_btn" placeholder="" id="config_mem_signup_btn" class="form-control" value="<?php echo $config_mem_signup_btn; ?>">
                                </div>
                            </div>
                              
                            <fieldset>
                            <legend>PayPal Payments Standard</legend>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Email</label>
                                <div class="col-sm-10">
                                    <input name="config_mem_pay_email" placeholder="" id="config_mem_pay_email" class="form-control" value="<?php echo $config_mem_pay_email ; ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" ><span data-toggle="tooltip" title="" data-original-title="Use the live or testing (sandbox) gateway server to process transactions?">Sandbox Mode</span></label>
                                <div class="col-sm-10">
                                    <label class="control-label" >
                                        <input type="radio" name="config_mem_pay_sandbox" id="config_mem_pay_sandbox" <?=($config_mem_pay_sandbox=='Yes')?'checked':''?> value="Yes"> Yes
                                    </label>
                                    <label class="control-label" >
                                    
                                        <input type="radio" name="config_mem_pay_sandbox" id="config_mem_pay_sandbox" <?=($config_mem_pay_sandbox=='No')?'checked':''?> value="No"> No
                                    </label>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Thanks Title</label>
                                <div class="col-sm-10">
                                    <input name="config_mem_pay_thanks" placeholder="" id="config_mem_pay_thanks" class="form-control" value="<?php echo $config_mem_pay_thanks ; ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >Thanks Detail</label>
                                <div class="col-sm-10">
                                    <textarea name="config_mem_pay_thanks_detail" placeholder="" id="config_mem_pay_thanks_detail" class="form-control" ><?php echo $config_mem_pay_thanks_detail ; ?></textarea>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-option">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="config_account_id_terms" id="input-account_terms" class="form-control">
                                            <option value="0"><?php echo $text_none; ?></option>
                                            <?php foreach ($informations as $information) { ?>
                                            <?php if ($information['information_id'] == $config_account_id_terms) { ?>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-account"><span data-toggle="tooltip" title="Forces people to agree to policy before an account can be created.">Account Policy</span></label>
                                    <div class="col-sm-10">
                        ...
                        <div class="tab-pane" id="tab-image">
                            ...
                            <div class="form-group ">
                                <label class="col-sm-2 control-label" for="">News Image Size</label>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <input type="text" name="config_image_news_width" value="<?php echo $config_image_news_width; ?>" placeholder="<?php echo $entry_width; ?>" id="" class="form-control" />
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" name="config_image_news_height" value="<?php echo $config_image_news_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                                        </div>
                                    </div>
  ...
  $('select[name=\'config_country_id\']').on('change', function () {
    ...
    <link href="view/javascript/dist/css/fontawesome-iconpicker.min.css" rel="stylesheet">
