                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog-article" class="form-horizontal">
                        ...
                        <ul class="nav nav-tabs">
        					...
        					<li><a href="#tab-option" data-toggle="tab"><?php echo $tab_option; ?></a></li>					
                                                <li style="display:none;"><a href="#tab-related" data-toggle="tab"><?php echo $tab_related; ?></a></li>
                        </ul>
                                    ...
                                    <?php foreach ($article_addition_description as $additional_description) { ?>
                                        <tbody id="additional-description<?php echo $module_row; ?>">
                                            <tr>
                                                ...
                                                <td class="text-left"><button type="button" onclick="$('#module-row<?php echo $module_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php $module_row++; ?>
