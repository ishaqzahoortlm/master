<?php echo $header; ?>
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-support-customer-ticket" class="form-horizontal">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                <div class="form-group required">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_customer; ?></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <label class="form-control"><?php echo $customer_name; ?></label>
                                ...
                                <div class="form-group required">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_ticket_id; ?></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="form-group required">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_subject; ?></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
    	    							...
    	    							<?php } else { ?>
    	    								...
    	    								<input type="hidden" name="subject" value="<?php echo $subject; ?>" size="100" />
    	    							<?php } ?> 
                                    </div>
                                </div>  
                            ...
                            <div class="tab-pane" id="tab-history">
                                <?php if($simple_support_ticket_id) { ?>
                                    <div style="border-bottom: 1px solid #cddddd; margin-bottom: 20px;">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_current_status; ?></label>
                                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_assign_user; ?></label>
                                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_ticket_status; ?></label>
                                ...
                                <div class="form-group required">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_department; ?></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="form-group required" id="assign-user-ticket" style="display:none">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_assign_ticket; ?></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="pull-right">
                                    <button type="submit" form="form-support-customer-ticket" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <script type="text/javascript">
    	function getDepartmentUser(department_id) {
    		...
    		if(department_id) {
    			...
    			$.ajax({
					url: 'index.php?route=simple_support/customer_ticket/departmentUser&token=<?php echo $token; ?>&department_id=' + department_id,
					dataType: 'json',
					beforeSend: function() {
    ...
    <?php if ($simple_support_ticket_id) { ?>
		...
		$('#history').delegate('.pagination a', 'click', function(e) {
			...
			$('#history').load('index.php?route=simple_support/customer_ticket/history&token=<?php echo $token; ?>&simple_support_ticket_id=<?php echo $simple_support_ticket_id; ?>');
		</script>
	<?php } ?>
    ...
    <script type="text/javascript">
        $('button[id=\'button-upload\']').on('click', function() {
        	...
        	$('#form-upload input[name=\'file\']').on('change', function() {
        		$.ajax({
        			url: 'index.php?route=simple_support/customer_ticket/upload&token=<?php echo $token; ?>',
        			type: 'post',
        			dataType: 'json',
