        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    ...
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-support-customer-ticket').submit() : false;"><i class="fa fa-trash-o"></i></button>-->
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-support-customer-ticket">
                                    ...
                                    <?php if($tickets) { ?>
                                        <?php foreach($tickets as $ticket) { ?>
                                            <tr>
        										...
        										<td class="text-left"><?php echo $ticket['customer_name']; ?></td>
