        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <button type="submit" form="form-support-faq-group" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-support-faq-group" class="form-horizontal">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <?php foreach ($languages as $language) { ?>
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="faq_group_name[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($faq_group_name[$language['language_id']]) ? $faq_group_name[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" class="form-control" />
                                    </div>
