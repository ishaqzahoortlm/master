...
class ControllerInformationNews extends Controller {
	public function index() {
		...
		$data['text_view'] = $this->language->get('text_view');
                $data['no_record'] = $this->language->get('no_record');
		...
		foreach ($all_news as $news) {
			$data['all_news'][] = array (
				...
				'image'			=> $this->model_tool_image->resize($news['image'], $this->config->get('config_image_news_width'), $this->config->get('config_image_news_height')),
	...
	public function news() {
		...
		if ($news) {
			...
			$data['image'] = $this->model_tool_image->resize($news['image'], $this->config->get('config_image_news_width'), $this->config->get('config_image_news_height'));
        ...
        public function feeds() {
            $json = array();
            $json['config_header_tag'] = $this->config->get('config_header_tag');
            $json['config_header_tag'] = $this->config->get('config_header_tag');
            $json['config_social_email'] =  $this->config->get('config_email');
            $json['config_social_facebook'] =  $this->config->get('config_social_facebook');
            $json['config_social_twitter'] =  $this->config->get('config_social_twitter');
            $json['config_social_linkedin'] =  $this->config->get('config_social_linkedin');
            $json['config_social_wordpress'] =  $this->config->get('config_social_wordpress');
            ...
            $json['config_footer_tag'] = $this->config->get('config_footer_tag');
