...
class ControllerModuleAccount extends Controller {
	public function index() {
		...
		$data['recurring'] = $this->url->link('account/recurring', '', 'SSL');
                $data['link_messages'] = $this->url->link('account/message', '', 'SSL');
                
                $this->load->model('account/thread');
                
                $data['supplier_total'] = $this->model_account_thread->getNewMessage($this->customer->getId(),'seller');
                $data['customer_total'] = $this->model_account_thread->getNewMessage($this->customer->getId(),'customer');
                
                //echo $data['supplier_total'];
                //exit;
