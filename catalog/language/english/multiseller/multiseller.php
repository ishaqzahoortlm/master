...
$_['ms_write_review'] = 'Write Review';
...
$_['ms_none'] = 'None';
$_['ms_list_name'] = 'Name';
$_['ms_list_location'] = 'Location';
$_['ms_list_category'] = 'Category';
$_['ms_list_certifications'] = 'Certifications';
$_['ms_list_certification'] = 'Certification';
$_['ms_rating'] = 'Rating';
$_['error_company'] = 'Company name cannot be empty';
...
// * Custome *
// **********
$_['ms_entry_email'] = 'Email';
$_['ms_entry_newletter'] = 'Keep me signed up for newsletter';
$_['ms_billing_address'] = 'Billing Address';
$_['ms_my_products'] = 'My Products';
$_['ms_featured_products'] = 'Featured Products';
$_['ms_review_products'] = 'Products with Reviews';
$_['ms_no_record'] = 'No Record Found';
$_['ms_edit_info'] = 'Supplier Information';
$_['ms_title_mission'] = 'Mission';
$_['ms_mission_char'] = 'Characters left';
$_['ms_city'] = 'City';
$_['ms_street'] = 'Street';
$_['ms_h_address'] = 'Headquarters Address';
$_['ms_leadership'] = 'Certified Distributors';
$_['ms_lp_f_name'] = 'First Name';
$_['ms_lp_l_name'] = 'Last Name';

$_['ms_lp_name'] = 'Name';
$_['ms_lp_address'] = 'Address';
$_['ms_lp_nature'] = 'Nature of distribution';

$_['ms_lp_phone'] = 'Phone';
$_['ms_contact_position'] = 'Position';
$_['ms_lp_title'] = 'Title';
$_['ms_lp_add_more'] = 'Add';
$_['ms_contact_title'] = 'Authorized Name of Officers, Owners or Partners';
$_['ms_category_title'] = 'Product Categories';
$_['ms_org_title'] = 'Types of organization';
$_['ms_org_no_profit'] = 'Non-profit';
$_['ms_org_profit'] = 'For profit';
$_['ms_revenue'] = 'Revenue last fiscal year';
$_['ms_countries'] = 'Office Locations';
$_['ms_ship_title'] = 'Ability to Ship';
$_['ms_ship_drop'] = 'Drop Ship';
$_['ms_ship_cont'] = 'Containers';
$_['ms_ship_no'] = 'No Ship';
$_['ms_refrences_title'] = 'References, if applicable';
$_['ms_refrences_dunn'] = 'Dunn and Bradstreet (Dunn\'s) number ';
$_['ms_refrences_employee'] = 'Employer Identification Number (EIN)';
$_['ms_membership_title'] = 'Related Associations & Memberships';
$_['ms_signup'] = 'Sign Up To Be a Supplier';
$_['ms_membership_options'] = 'Membership Options';
$_['btn_member_ship_plane'] = 'Change Membership Plan';
$_['btn_new_product'] = 'Upload a New Product';

$_['ms_required_field'] = ' Please input the required field';
$_['ms_required_fields'] = ' Please input the required fields';

$_['ms_date_created'] = 'Date created';
$_['ms_date'] = 'Date';
$_['ms_moq'] = 'MOQ';
$_['ms_moq_title'] = 'Minimum Order Quantity for large orders';
$_['ms_warranty'] = 'Warranty';
$_['ms_w_description'] = 'Description';
$_['ms_factory_time'] = 'Factory Lead Time';
$_['all_product_q'] = 'Product Quote';
...
$_['ms_totals_line'] = 'Curnently %s suppliers and %s products for sale!';

$_['ms_text_welcome'] = '<a href="%s">Login</a> | <a href="%s">Create an account</a> | <a href="%s">Create a seller account</a>.';
$_['ms_button_register_seller'] = 'Register as a supplier';
$_['ms_register_seller_account'] = 'Register a supplier account';
...
$_['ms_mail_ending'] = "\n\nRegards,\n%s";
$_['ms_mail_ending_html'] = "<br/><b>Regards,<b><br/>";
$_['ms_mail_message'] = "\n\nMessage:\n%s";

$_['ms_mail_subject_seller_account_created'] = 'Supplier account created';
...
$_['ms_mail_subject_seller_account_awaiting_moderation'] = 'Supplier account awaiting moderation';
...
$_['ms_mail_contact'] = 'New customer message';
$_['ms_mail_contact_new_msg'] = 'You have a new customer message';

$_['ms_mail_reply_back'] = 'New supplier message';
$_['ms_mail_reply_back_msg'] = 'You have a new supplier message';
...
Your product's %s listing has finished. Go to your account area if you would like to re-list the product.
EOT;

// *********
// * Admin *
// *********
$_['ms_mail_admin_subject_seller_account_created'] = 'New supplier account created';
$_['ms_mail_admin_seller_account_created'] = <<<EOT
New seller account at %s has been created!<br/>
<b>Seller name:</b> %s (%s) <br/>
<b>E-mail:</b> %s
EOT;

$_['ms_mail_admin_subject_seller_account_awaiting_moderation'] = 'New supplier account awaiting moderation';
$_['ms_mail_admin_seller_account_awaiting_moderation'] = <<<EOT
New seller account at %s has been created and is now awaiting moderation.<br/>
<b>Seller name:</b> %s (%s) <br/>
<b>E-mail:</b> %s

<br/> You can process it in the suppliers section in back office.
EOT;
...
$_['ms_error_sellerinfo_terms'] = 'Warning: You must agree to the %s and %s!';
...
$_['ms_error_form_submit_error'] = 'Error occured when submitting the form. Please contact us for more information.';
...
$_['ms_account_register_new'] = 'New Supplier';
$_['ms_account_register_seller'] = 'Register Supplier Account';
$_['ms_account_register'] = 'Register Account';
$_['ms_account_register_seller_note'] = 'Create a supplier account and start selling your products !';
$_['ms_account_register_details'] = 'Step 1: Your Details';
$_['ms_account_register_seller_success_heading'] = 'Your Supplier Account Has Been Created!';
$_['ms_account_register_seller_success_message']  = '<p>Welcome to %s!</p> <p>Congratulations! Your new supplier account has been successfully created!</p> <p>You can now take advantage of seller privileges and start selling your products with us.</p> <p>If you have any problems, <a href="%s">contact us</a>.</p>';
$_['ms_account_register_seller_success_approval'] = '<p>Welcome to %s!</p> <p>Your supplier account has been registered and is waiting for approval. You will be notified by email once your account has been activated .</p><p>If you have any problems, <a href="%s">contact us</a>.</p>';

$_['ms_seller'] = 'Seller';
$_['ms_seller_forseller'] = 'For supplier';
$_['ms_account_dashboard'] = 'Dashboard';
$_['ms_account_seller_account'] = 'Supplier Account';
$_['ms_account_customer_account'] = 'Customer Account';
$_['ms_account_sellerinfo'] = 'Supplier profile';
$_['ms_account_sellerinfo_new'] = 'New supplier account';
$_['ms_account_newproduct'] = 'New product';
$_['ms_account_products'] = 'Products';
$_['ms_product_quote'] = 'Product Quote';
$_['ms_product_review'] = 'Product Review';
...
$_['ms_account_product_quote'] = 'Product Quote';
$_['ms_account_returns'] = 'Returns';
$_['ms_account_request_payout'] = 'Request Payout';
$_['ms_account_password'] = 'Password';
...
$_['ms_account_product_listing_balance'] = 'This amount will be deducted from your supplier balance.';
...
$_['ms_account_product_image_one'] = 'Image';
...
$_['ms_account_product_mpn_note'] = 'Supplier Part Number';
$_['ms_account_product_manufacturer'] = 'Supplier';
...
// Account - Seller
$_['ms_account_sellerinfo_heading'] = 'Supplier Profile';
$_['ms_account_sellerinfo_breadcrumbs'] = 'Supplier Profile';
$_['ms_account_sellerinfo_nickname'] = 'Nickname';
$_['ms_account_sellerinfo_nickname_note'] = 'Specify your supplier nickname.';
...
$_['ms_account_sellerinfo_fee_flat'] = 'There is a signup fee of <span>%s</span> to become a supplier at %s.';
...
$_['ms_account_sellerinfo_signup_itemname'] = 'Supplier account registration at %s';
$_['ms_account_sellerinfo_saved'] = 'Supplier account data saved.';

$_['ms_account_status'] = 'Your Supplier account status is: ';
$_['ms_account_status_tobeapproved'] = '<br />You will be able to use your account as soon as it is approved .';
$_['ms_account_status_please_fill_in'] = 'Please complete the following form to create a supplier account.';
...
$_['ms_account_products_noproducts'] = 'No product found!';
...
$_['ms_mail_subject_seller_vote'] = 'Vote for the supplier';
$_['ms_mail_seller_vote_message'] = 'Vote for the supplier';
...
$_['ms_account_orders_status_update'] = 'Status has been updated';
// Account - Dashboard
$_['ms_account_dashboard_heading'] = 'Supplier Dashboard';
$_['ms_account_dashboard_breadcrumbs'] = 'Supplier Dashboard';
$_['ms_account_dashboard_orders'] = 'Last orders';
$_['ms_account_dashboard_overview'] = 'Overview';
$_['ms_account_dashboard_seller_group'] = 'Supplier group';
...
$_['ms_account_dashboard_nav_profile'] = 'Modify your supplier profile';
$_['ms_account_dashboard_nav_product'] = 'Add new product';
...
$_['ms_catalog_product_sellerinfo'] = 'Supplier information';
$_['ms_catalog_product_contact'] = 'Contact this supplier';

$_['ms_footer'] = '';

// Catalog - Sellers list
$_['ms_catalog_sellers_heading'] = 'Suppliers';
...
$_['ms_catalog_sellers'] = 'Suppliers';
$_['ms_catalog_sellers_empty'] = 'There are no suppliers yet.';
...
$_['ms_catalog_seller_profile_about_seller'] = 'About the supplier';
$_['ms_catalog_seller_profile_products'] = 'Some of supplier\'s products';
...
$_['ms_catalog_seller_products_empty'] = 'No product found!';

// Catalog - Seller contact dialog
$_['ms_sellercontact_title'] = 'Send a message to supplier';
$_['ms_sellercontact_signin'] = 'Please sign in to contact %s';
...
$_['ms_product_quote_heading'] = 'Product Quote';
$_['ms_qt_name'] = 'Name';
$_['ms_qt_product'] = 'Product';
$_['ms_qt_date'] = 'Date';
$_['ms_qt_actions'] = 'Actions';
$_['ms_qt_detail'] = 'Request For Quotes';
$_['ms_qt_status'] = 'Status';
$_['ms_product_quote_update'] = 'Detail';

$_['ms_product_review_heading'] = 'Product Review';
$_['all_product_review'] = 'Product Review';
$_['product_review'] = 'Product Review';
$_['product_review_rating'] = 'Rating';
$_['ms_product_faq'] = 'FAQ';
$_['ms_faq_q'] = 'Question';
$_['ms_faq_a'] = 'Answer';
$_['ms_faq_create'] = 'Create FAQ';
$_['ms_faq_sort_order'] = 'Sort Order';
$_['ms_account_settings'] = 'Setting';
$_['ms_price_for_products'] = 'Price for maximum order ';
$_['ms_price_for_products_default'] = '0 will be Unlimited';
$_['ms_product_message'] = 'Messages';
$_['ms_product_message_by'] = 'By';
$_['ms_message_product'] = 'Product';
$_['ms_all_message'] = 'All Messages';
$_['ms_btn_reply'] = 'Reply';
$_['ms_title_reply'] = 'Reply Back';
$_['ms_reply_send'] = 'Your message has been successfully sent';
$_['ms_review'] = 'Review';
$_['ms_product_return'] = 'Returns';
$_['ms_product_return_heading'] = 'Product Returns';
$_['ms_order_id'] = 'Order ID';
$_['ms_order_customer'] = 'Customer';
$_['ms_order_product'] = 'Product';
$_['ms_return_date'] = 'Date Added';
$_['ms_return_tab_history'] = 'History';
...
$_['ms_text_order']         = 'Order Information';
$_['column_customer']    = 'Customer';
$_['ms_text_pr'] = 'Product Information & Reason for Return';
$_['ms_text_rr'] = 'Return Reason';
$_['ms_text_rs'] = 'Return Status';
$_['ms_text_rc'] = 'Comment';
$_['column_action']      = 'Action';
$_['ms_heading_history']      = 'Add Return History';
$_['ms_text_nc'] = 'Notify Customer';
$_['ms_button_history'] = 'Add History';
$_['ms_clm_date_add'] = 'Date Added';
$_['ms_text_status'] = 'Status';
