...
class ModelShippingFedex extends Model {
	function getQuote($address) {
		...
		if ($status) {
			...
			$xml .= '				<ns1:certificationCount>1</ns1:certificationCount>';
			$xml .= '				<ns1:RequestedcertificationLineItems>';
			$xml .= '					<ns1:SequenceNumber>1</ns1:SequenceNumber>';
			$xml .= '					<ns1:GroupcertificationCount>1</ns1:GroupcertificationCount>';
			$xml .= '					<ns1:Weight>';
