$(function () {
    $("#ms-submit-button").click(function () {
        $('.success').remove();
        $('#profile_error').hide();
        $('#bsmSelect form-controlbsmContainer0,#bsmSelect form-controlbsmContainer1,.multiple_countries,.multiple_category').removeClass('has-error');
        var button = $(this);
        var id = $(this).attr('id');
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: $('base').attr('href') + 'index.php?route=seller/account-profile/jxsavesellerinfo2',
            ...
            success: function (jsonData) {
                ...
                if (!jQuery.isEmptyObject(jsonData.errors)) {
                    ...
                    $('#profile_error').html(jsonData.ms_required_fields).show();
