        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1" >
            <thead>
                <tr>
                    ...
                    <th style="width:18%;"><?=$ms_date?></th>
                    <th style="width:10%;"><?=$ms_status?></th>
                    <th style="width:5%;"><?=$ms_action?></th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        <a class="btn-sm btn-primary "  href="<?=$this->url->link('account/message/view', 'r_id=' . md5($row['id']))?>"><i class="fa fa-envelope"></i></a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
