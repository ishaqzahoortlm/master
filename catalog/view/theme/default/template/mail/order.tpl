...
<div style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    <div style="width: 100%;">
        ...
        <p style="margin-top: 0px; margin-bottom: 20px;"><a href="<?php echo $link; ?>">View Order</a></p>
        <?php } ?>
        <?php if ($download) { ?>
        <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_download; ?></p>
        <p style="margin-top: 0px; margin-bottom: 20px;"><a href="<?php echo $download; ?>">Download</a></p>
        <?php } ?>
