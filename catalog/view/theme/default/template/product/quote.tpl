            ...
            <div class="col-sm-8">
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" value="<?=$product_name?>" readonly name="product_name" id="product_name" class="form-control">
                    </div>
                </div>
...
<script type="text/javascript"><!--
    ...
    $('#id_submit_q').on('click', function () {
        ...
        $.post("index.php?route=product/product/addquote", $('#form_q').serialize(),function(data){
		  var obj = eval(data);
