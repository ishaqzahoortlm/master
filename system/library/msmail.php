		...
		switch($mail_type) {
			...
			case self::SMT_SELLER_ACCOUNT_CREATED:
				...
				$mail_text ='<tr>
                                             ...
                                             <p>'.sprintf($this->language->get('ms_mail_seller_account_created'), $this->config->get('config_name')).'</p>       
                                             <br/>
			...
			case self::SMT_SELLER_ACCOUNT_AWAITING_MODERATION:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <h2 style="color:#000;">Hi ,</h2>
                                             <p>'.sprintf($this->language->get('ms_mail_seller_account_awaiting_moderation'), $this->config->get('config_name')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_SELLER_ACCOUNT_MODIFIED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <h2 style="color:#000;">Hi ,</h2>
                                             <p>'.sprintf($this->language->get('ms_mail_seller_account_modified'), $this->config->get('config_name'), $this->language->get('ms_seller_status_' . $seller['ms.seller_status'])).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_PRODUCT_AWAITING_MODERATION:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <h2 style="color:#000;">Hi ,</h2>
                                             <p>'.sprintf($this->language->get('ms_mail_product_awaiting_moderation'), $product['name'], $this->config->get('config_name')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_PRODUCT_MODIFIED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <h2 style="color:#000;">Hi ,</h2>
                                             <p>'.sprintf($this->language->get('ms_mail_product_modified'), $product['name'], $this->config->get('config_name'), $this->language->get('ms_product_status_' . $product['mp.product_status'])).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_PRODUCT_PURCHASED:
				...
				foreach ($order_products as $p) {
					...
					$products .= "{$p['name']} " . $this->currency->format($p['seller_net_amt'], $this->config->get('config_currency')) . "<br/>";
				...
				$message_data = '';
					...
					$message_data .= sprintf($this->language->get('ms_mail_product_purchased'), $this->config->get('config_name'), $order_info['firstname'] . ' ' . $order_info['lastname'], $order_info['email'], $products, $total);
				} else {
					$message_data .= sprintf($this->language->get('ms_mail_product_purchased_no_email'), $this->config->get('config_name'), $order_info['firstname'] . ' ' . $order_info['lastname'], $products, $total);
				}

				$order_info['comment'] = $this->MsLoader->MsOrderData->getOrderComment(array('order_id' => $data['order_id'], 'seller_id' => $data['seller_id']));
				if ($order_info['comment']) {
					$message_data .= sprintf($this->language->get('ms_mail_product_purchased_comment'), $order_info['comment']);
				}

				if ($this->config->get('msconf_provide_buyerinfo') == 1 || ($this->config->get('msconf_provide_buyerinfo') == 2 && $product['shipping'] == 1))
				{
					$message_data .= sprintf($this->language->get('ms_mail_product_purchased_info'), $order_info['shipping_firstname'], $order_info['shipping_lastname'], $order_info['shipping_company'], $order_info['shipping_address_1'], $order_info['shipping_address_2'], $order_info['shipping_city'], $order_info['shipping_postcode'], $order_info['shipping_zone'], $order_info['shipping_country']);
				}
			...
			case self::SMT_WITHDRAW_REQUEST_SUBMITTED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_withdraw_request_submitted')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_WITHDRAW_REQUEST_COMPLETED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_withdraw_request_completed')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_WITHDRAW_REQUEST_DECLINED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_withdraw_request_declined'), $this->config->get('config_name')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			*/
			case self::SMT_TRANSACTION_PERFORMED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_transaction_performed'), $this->config->get('config_name')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_SELLER_CONTACT:
                                $send_as = 'html';
				$mail_subject .= $this->language->get('ms_mail_contact');
                                
                                
                                $mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <h2 style="color:#000;">Hi '.$data['addressee'].',</h2>
                                ...
                                /*
				if (!$this->config->get('msconf_hide_emails_in_emails')) {
                                        $mail_text .= $this->language->get('ms_mail_contact_new_msg');//sprintf($this->language->get('ms_mail_seller_contact'), $data['customer_name'], $data['customer_email'], isset($product['name']) ? $product['name'] : '', $data['customer_message']);
				} else {
					$mail_text .= $this->language->get('ms_mail_contact_new_msg');//sprintf($this->language->get('ms_mail_seller_contact_no_mail'), $data['customer_name'], isset($product['name']) ? $product['name'] : '', $data['customer_message']);
				}*/
				break;
			...
			case self::SMT_SELLER_VOTE:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_seller_vote_message'), $data['customer_name'], $data['title'], $data['customer_message']).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::SMT_REMIND_LISTING:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_seller_remind_listing'), $product['name']).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::AMT_PRODUCT_CREATED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_admin_product_created'), $product['name'], $this->config->get('config_name')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::AMT_SELLER_ACCOUNT_CREATED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_admin_seller_account_created'), $this->config->get('config_name'), $data['seller_name'], $data['customer_name'], $data['customer_email']).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::AMT_SELLER_ACCOUNT_AWAITING_MODERATION:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_admin_seller_account_awaiting_moderation'), $this->config->get('config_name'), $data['seller_name'], $data['customer_name'], $data['customer_email']).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::AMT_NEW_PRODUCT_AWAITING_MODERATION:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_admin_new_product_awaiting_moderation'), $product['name'], $this->config->get('config_name')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::AMT_EDIT_PRODUCT_AWAITING_MODERATION:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_admin_edit_product_awaiting_moderation'), $product['name'], $this->config->get('config_name')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
			...
			case self::AMT_WITHDRAW_REQUEST_SUBMITTED:
				...
				$mail_text ='<tr>
                                             <td style="line-height:22px;">
                                             <p>'.sprintf($this->language->get('ms_mail_admin_withdraw_request_submitted')).'</p>       
                                             <br/>
                                             '.$this->language->get('ms_mail_ending_html').$this->config->get('config_name').'
                                             </td>
                                            </tr>';
		...
		$mail->setSubject($mail_subject);
                if($send_as=='html'){
                    ...
                    if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mail/template.tpl')) {
                                $mail_text = $this->load->view($this->config->get('config_template') . '/template/mail/template.tpl', $data);
                        } else {
                                $mail_text = $this->load->view('default/template/mail/template.tpl', $data);
                        }
