...
class MsProduct extends Model {
			...
			$sql = "INSERT INTO " . DB_PREFIX . "product_description
					SET product_id = " . (int)$product_id . ",
						name = '". $this->db->escape($language['product_name']) ."',
                                                meta_title = '". $this->db->escape($language['product_name']) ."',    
	...
	public function getProduct($product_id) {
		$sql = "SELECT 	p.price,p.price_for,
		                p.model,p.certifications, p.sku, p.upc, p.ean, p.jan, p.isbn, p.mpn,
