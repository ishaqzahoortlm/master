...
class ControllerAccountAccount extends Controller {
	public function index() {
		...
		if (!$this->customer->isLogged()) {
			...
			$this->response->redirect($this->url->link('account/login', '', 'SSL'));
                ...
                if ($this->customer->isLogged()) {
                    ...
                    $buyer_to_seller = "";
                    if(isset($this->session->data['buyer_to_seller'])){
                        $buyer_to_seller = $this->session->data['buyer_to_seller'];
                    }
                    if($total>0 && $buyer_to_seller==""){
		...
		$data['text_address'] = $this->language->get('text_address');
                $data['text_address_dashboard'] = $this->language->get('text_address_dashboard');
