...
class ModelCatalogProduct extends Model {
    ...
    public function getProduct($product_id) {
        ...
        if ($query->num_rows) {
            return array(
                ...
                'certifications' => $query->row['certifications'],
                'sku' => $query->row['sku'],
                'upc' => $query->row['upc'],
                'ean' => $query->row['ean'],
                'jan' => $query->row['jan'],
    ...
    public function getCertificationDescription($certification_id) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "certification_description WHERE language_id = '" . (int) $this->config->get('config_language_id') . "' AND certification_id = '" . (int) $certification_id . "'");
        $certification_description = array();
        foreach ($query->rows as $result) {
            $certification_description = array(
                'title' => $result['title']
            );
