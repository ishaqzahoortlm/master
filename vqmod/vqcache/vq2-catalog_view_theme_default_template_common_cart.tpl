...
<div id="cart" class="btn-group ">
  <a class="cart-count contain-count shopingcart" href="javascript:void(0)" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>"><i class="fa fa-shopping-cart"></i></a>  
  <ul class="dropdown-menu pull-right btn-block">
      ...
      <table class="table table-striped ">
        ...
        <tr>
          ...
          <td class="text-center">
              <span class="label label-danger" style="font-size: 100%; cursor: pointer;" onclick="cart.remove('<?php echo $product['key']; ?>');" title="<?php echo $button_remove; ?>"><i class="fa fa-trash-o"></i></span>
              </td>
        </tr>
        <?php } ?>
