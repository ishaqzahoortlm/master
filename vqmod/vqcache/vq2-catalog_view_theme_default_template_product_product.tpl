			...
			<div class="ms-sellerprofile description" >
				...
				<div class="seller-data">
					...
					<ul class="list-unstyled">
					    <li><a class="" style="text-decoration: none" href="<?php echo $seller['href']; ?>"><b><?php echo $seller['nickname']; ?></b></a></li>
						<?php if ($seller['country']) { ?>
							<li><b><?php echo $ms_catalog_seller_profile_country; ?></b> <?php echo $seller['country']; ?></li>
						<?php } ?>

						<?php if ($seller['zone']) { ?>
							<li><b><?php echo $ms_catalog_seller_profile_zone; ?></b> <?php echo $seller['zone']; ?></li>
						<?php } ?>

						<?php if ($seller['company']) { ?>
							<li><b><?php echo $ms_catalog_seller_profile_company; ?></b> <?php echo $seller['company']; ?></li>
						<?php } ?>

						<?php if ($seller['website']) { ?>
							<li><b><?php echo $ms_catalog_seller_profile_website; ?></b> <?php echo $seller['website']; ?></li>
						<?php } ?>

						<li style="display:none;"><?php echo $ms_catalog_seller_profile_totalsales; ?></b> <?php echo $seller['total_sales']; ?></li>
						<li><b><?php echo $ms_catalog_seller_profile_totalproducts; ?></b> <?php echo $seller['total_products']; ?></li>
                                                <li>
                                                <?php if ($this->config->get('mmess_conf_enable') || $this->config->get('msconf_enable_private_messaging') == 2) { ?>
                                                    ...
                                                    <?php if ($this->customer->getId()) { ?>
                                                    <a id=""   class="   ms-sellercontact" data-toggle="modal" data-target="#contactDialog"><button onclick="$('#ms-sellercontact-text').val(''); $('.alert alert-success').hide();" class="btn btn-primary"><?=$btn_seller_contact?></button></a>
                                                    <?php } else { ?>
                                                    <?php $aler_contact =  sprintf($this->language->get('ms_sellercontact_signin'), '', $seller['nickname']); ?>
                                                    <a id=""  onclick="javascript:alert('<?=$aler_contact?>')" class=""><button class="btn btn-primary"><?=$btn_seller_contact?></button></a>
                                                    <?php } ?>
                                                    <?php } ?>
                                                    <?php } ?>                       
                                                </li>    
