...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_information'] = $this->language->get('text_information');
                $data['text_group_faq'] = $this->language->get('text_group_faq');
                $data['text_faq'] = $this->language->get('text_faq');
                $data['text_hd_blog'] = $this->language->get('text_hd_blog');
                $data['text_hd_blog_category'] = $this->language->get('text_hd_blog_category');
                $data['text_hd_blog_article'] = $this->language->get('text_hd_blog_article');
                $data['text_hd_blog_auther'] = $this->language->get('text_hd_blog_auther');
                $data['text_hd_blog_comment'] = $this->language->get('text_hd_blog_comment');
                $data['text_hd_blog_report'] = $this->language->get('text_hd_blog_report');
                $data['text_custome_package'] = $this->language->get('text_custome_package');
                $data['text_custome_certifications'] = $this->language->get('text_custome_certifications');
		...
		$data['text_review'] = $this->language->get('text_review');
                $data['text_buyer_review'] = 'Buyer Reviews';
		...
		$data['text_openbay_order_import'] = $this->language->get('text_openbay_order_import');
			...
			$data['text_contract_status_modifier'] = $this->language->get('text_contract_status_modifier');
                ...
                $data['text_emails'] = $this->language->get('text_emails');
		...
		$data['information'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'], 'SSL');
                $data['groupfaq'] = $this->url->link('simple_support/faq_group', 'token=' . $this->session->data['token'], 'SSL');
		$data['faq'] = $this->url->link('simple_support/faq', 'token=' . $this->session->data['token'], 'SSL');
                $data['blog_auther'] = $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'], 'SSL');
                $data['blog_category'] = $this->url->link('simple_blog/category', 'token=' . $this->session->data['token'], 'SSL');
                $data['blog_article'] = $this->url->link('simple_blog/article', 'token=' . $this->session->data['token'], 'SSL');
                $data['tblog_comment'] = $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'], 'SSL');
                $data['blog_report'] = $this->url->link('simple_blog/report', 'token=' . $this->session->data['token'], 'SSL');
                $data['custom_news'] = $this->url->link('extension/news', 'token=' . $this->session->data['token'], 'SSL');
                $data['custom_package'] = $this->url->link('extension/package', 'token=' . $this->session->data['token'], 'SSL');
                $data['custom_certification'] = $this->url->link('extension/certification', 'token=' . $this->session->data['token'], 'SSL');
                $data['custom_email'] = $this->url->link('extension/email', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['review_buyer'] = $this->url->link('catalog/reviewbuyer', 'token=' . $this->session->data['token'], 'SSL');
